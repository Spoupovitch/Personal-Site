...
//toggle site theme
function toggleBG() {
	let body, sky, banner, city, profile_pic, light_dark_btn, light_dark_icon;
	body = document.getElementById("body");
	sky = document.getElementById("sky");
	banner = document.getElementById("mid_banner");
	city = document.getElementById("city");
	profile_pic = document.getElementById("profile_pic");
	light_dark_btn = document.getElementById("light-dark_btn");
	light_dark_icon = document.getElementById("light-dark_icon");
	...
	if (skyTheme === "dark-mode") {
		...
		light_dark_btn.className = "light-mode";
		light_dark_icon.className = "fas fa-moon";
	}
	else {
		...
		light_dark_btn.className = "dark-mode";
		light_dark_icon.className = "fas fa-sun";
	}
}
